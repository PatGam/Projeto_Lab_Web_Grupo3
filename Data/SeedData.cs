...
namespace Projeto_Lab_Web_Grupo3.Data
{
    public class SeedData
    {
        ...
        private static void InsereUtilizadores(Projeto_Lab_WebContext bd)
        {
            ...
            //    //-------------------------- 6 COIMBRA-----------------
            GaranteUtilizadores(bd, "Patrícia Gomes", "248858939", new DateTime(1999, 07, 01), "Rua do Norte", "929154121", "patricia.gomes@RDtelecom.com", "3000-295", "Operador", false, "Coimbra", new DateTime(2020, 10, 05), 0, 6);
            GaranteUtilizadores(bd, "Marlene Santos", "123456789", new DateTime(1988, 11, 21), "Rua Particular Ladeira do Baptista", "933254121", "marlene.satos@RDtelecom.com", "3030-253", "Operador", false, "Coimbra", new DateTime(2020, 12, 01), 0, 6);
            GaranteUtilizadores(bd, "João Ferreira", "233333231", new DateTime(1978, 07, 01), "Avenida Saraiva de Carvalho", "929154121", "joao.ferreira@RDtelecom.com", "3084-501", "Operador", false, "Coimbra", new DateTime(2020, 11, 26), 0, 6);
            ...
            GaranteUtilizadores(bd, "Paulo Pedra", "215922158", new DateTime(1999, 07, 01), "Rua do Norte", "929154121", "paulo.pedra@RDtelecom.com", "3000-295", "Operador", false, "Coimbra", new DateTime(2020, 10, 11), 0, 6);
            GaranteUtilizadores(bd, "Helder Copeto", "209281472", new DateTime(1999, 07, 01), "Rua do Norte", "929154121", "helder.copeto@RDtelecom.com", "3000-295", "Operador", false, "Coimbra", new DateTime(2020, 10, 11), 0, 6);
            GaranteUtilizadores(bd, "Miriam Falcão", "218052421", new DateTime(2000, 01, 01), "Vale Derradeiro", "929154121", "miriam.falcao@RDtelecom.com", "3320-002", "Operador", false, "Coimbra", new DateTime(2020, 10, 11), 0, 6);
            GaranteUtilizadores(bd, "Célia Tomate", "224046284", new DateTime(1980, 09, 11), "Seladinhas", "929154121", "celia.tomate@RDtelecom.com", "3320-367", "Operador", false, "Coimbra", new DateTime(2021, 02, 18), 0, 6);
            GaranteUtilizadores(bd, "Tadeu Leão", "294178775", new DateTime(1975, 02, 08), "Flor da Rosa", "929154121", "tadeu.leao@RDtelecom.com", "3040-471", "Operador", false, "Coimbra", new DateTime(2021, 03, 11), 0, 6);
            GaranteUtilizadores(bd, "Harley Guerra", "230936679", new DateTime(1955, 12, 24), "Beco da Alegria", "929154121", "harley.guerra@RDtelecom.com", "3025-129", "Operador", false, "Coimbra", new DateTime(2021, 02, 20), 0, 6);
            GaranteUtilizadores(bd, "Afonso Freira", "271671130", new DateTime(1956, 12, 05), "Beco das Cruzes", "929154121", "afonso.freira@RDtelecom.com", "3000-133 ", "Operador", false, "Coimbra", new DateTime(2021, 01, 11), 0, 6);
            ...
            GaranteUtilizadores(bd, "Helder Machado", "174189800", new DateTime(1999, 07, 01), "Bairro do Carrapacho", "91523321", "Helder.machado@RDtelecom.com", "9880-120", "Operador", false, "Açores", new DateTime(2020, 11, 01), 0, 19);
            ...
            GaranteUtilizadores(bd, "Paula Falcão", "172885205", new DateTime(2000, 01, 26), "Rua Nova Rochinha", "974521333", "paula.falcao@RDtelecom.com", "9064-509", "Operador", false, "Madeira", new DateTime(2020, 12, 17), 0, 20);
