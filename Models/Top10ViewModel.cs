...
namespace Projeto_Lab_Web_Grupo3.Models
{
...

    {
        ...
        public List<LucroClienteOperador> clientesAveiro { get; set; }

        public List<LucroClienteOperador> clientesBeja { get; set; }

        public List<LucroClienteOperador> clientesBraga { get; set; }

        public List<LucroClienteOperador> clientesBraganca { get; set; }

        public List<LucroClienteOperador> clientesCasteloBranco { get; set; }

        public List<LucroClienteOperador> clientesCoimbra { get; set; }

        public List<LucroClienteOperador> clientesEvora { get; set; }

        public List<LucroClienteOperador> clientesFaro { get; set; }

        public List<LucroClienteOperador> clientesGuarda { get; set; }

        public List<LucroClienteOperador> clientesLeiria { get; set; }

        public List<LucroClienteOperador> clientesLisboa { get; set; }

        public List<LucroClienteOperador> clientesPortalegre { get; set; }

        public List<LucroClienteOperador> clientesPorto { get; set; }

        public List<LucroClienteOperador> clientesSantarem { get; set; }

        public List<LucroClienteOperador> clientesSetubal { get; set; }

        public List<LucroClienteOperador> clientesVianadoCastelo { get; set; }

        public List<LucroClienteOperador> clientesVilaReal { get; set; }

        public List<LucroClienteOperador> clientesViseu { get; set; }

        public List<LucroClienteOperador> clientesAcores { get; set; }
